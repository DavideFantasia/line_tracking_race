...
class Model:
    def __init__(self, dt=0.05, horizon=15):
        ...
        self.Qf_d   = 1.0 * self.weight_d
        self.Qf_psi = 1.0 * self.weight_psi
    ...
    def cost_function(self, controls, current_state, gamma_0):
        ...
        for i in range(self.horizon):
            ...
            gamma = self.gamma_function(sigma, gamma_0) #aggiornamento di gamma nella previsione (col valore aggiornato di sigma)
            ...
            cost += 0.5 * self.weight_v * ((self.v_target - v) ** 2) # termine extra
